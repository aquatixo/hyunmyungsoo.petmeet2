...
<body>
	<div class='container'>
			...
			<div class='col mt-2'>
				...
				<div class='form-inline justify-content-center mt-1'>
					<label for='sitterAddr' class='col-4 col-form-label text-center m-0 p-0'>주소</label> 
						<input type='text' class='form-control col-2 m-0 p-0 text-center'
							id='sitterAddr' value='${sitter.sitterLocSi}시' readonly />
						<input type='text' class='form-control col-2 m-0 p-0 text-center'
							id='sitterAddr' value='${sitter.sitterLocGu}구' readonly />
						<input type='text' class='form-control col-2 m-0 p-0 text-center'
							id='sitterAddr' value='${sitter.sitterLocDong }동' readonly />
				</div>
			</div>
		...
		<div class='d-flex form-group justify-content-end'>
			...
			<a href='sitterList' class='btn btn-outline-primary mt-3' data-dismiss='modal'>목록</a>
		</div>
		
		<form action='sitterView/del' method='post'>
